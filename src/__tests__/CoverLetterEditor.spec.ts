...
describe('CoverLetterEditor', () => {
    describe('parseDescription', () => {
        it('renders plain text without any <strong> elements', () => {
            ...
            expect(wrapper.find('.cl-paper__jobdesc strong').exists()).toBe(
                false,
            );
            expect(wrapper.find('.cl-paper__jobdesc').text()).toBe(
                'Plain text only',
            );
        });
        ...
        it('handles bold at the start of text', () => {
            const wrapper = mountEditor({
                descriptionText: '**Bold** then plain',
            });
            expect(wrapper.find('.cl-paper__jobdesc strong').text()).toBe(
                'Bold',
            );
        ...
        it('handles bold at the end of text', () => {
            const wrapper = mountEditor({
                descriptionText: 'Plain then **Bold**',
            });
            expect(wrapper.find('.cl-paper__jobdesc strong').text()).toBe(
                'Bold',
            );
