...
describe('JobCardCosineSimilarity', () => {
    ...
    describe('clamped value (aria-valuenow)', () => {
        it('clamps -0.5 to 0', () => {
            ...
            expect(wrapper.find(indicator).attributes('aria-valuenow')).toBe(
                '0',
            );
        });
    ...
    describe('matchLevel labels', () => {
        it('shows "poor match" for values below 0.25', () => {
            ...
            expect(
                wrapper.find(indicator).attributes('aria-valuetext'),
            ).toContain('poor match');
        });
    ...
    describe('fillColor', () => {
        ...
        it('produces different colors at 0 and 1 (hue interpolates)', () => {
            ...
            const high = mount(JobCardCosineSimilarity, {
                props: { value: 1 },
            });
            const styleLow =
